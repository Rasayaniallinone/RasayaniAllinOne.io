...
var footerSection =  '<br><br><footer class="footer">'+
                ...
                '<div class="row">'+
                    '<div class="col-md-9">'+
                        '<div class="footer-text one">'+
                            '<h3>CONTACT US</h3>'+
                            '<ul>'+
                                '<li><a href="javascript:void(0)"><i class="material-icons">location_on</i>Durgamata Colony, Chambarli ,Rasayani</a></li>'+
                                '<li><a href="mailto:info@rasayaniallinone.in" target="_blank"><i class="material-icons">email</i>info@rasayaniallinone.in</a></li>'+							''+								
								'<li><a href="'+myPath+'PrivacyPolicy.html"><i class="material-icons">privacy_tip</i>Privacy Policy / Team & Condition</a></li>'+
								'<li>'+
									'<a target="_blank" href="https://api.whatsapp.com/send?phone=+919766628471&amp;text=Hi"><img src="'+myPath+'img/whatsapp.png" style="height:40px"></a>&nbsp;&nbsp;'+
									'<a href="#" onclick="return openFBDetails();" ><img style="height:40px" src="'+myPath+'img/fb.png"></a>&nbsp;&nbsp;'+
									'<a target="_blank" href="http://twitter.com/share?text=RasayaniAllinOne Best website in Navi Mumbai&url=http://rasayaniallinone.in&hashtags=Rasayani,Panvel,NaviMumbai" ><img src="'+myPath+'img/twitter.png" style="height:40px" /></a>&nbsp;&nbsp;'+
									'<a href="tel:9766628471"><img style="height:40px" src="'+myPath+'img/callus.png"></a>&nbsp;&nbsp;'+
									'<a href="mailto:info@rasayaniallinone.in" target="_blank"><img style="height:40px" src="'+myPath+'img/email.png"></a>'+
								'</li>'+
				    		'</ul>'+
                        '</div>'+
                    '</div>'+
					'<div class="col-md-3">'+
                        '<div class="footer-text one">'+
                            ...
                            '<ul>'+
								...
								'<li class="playStoreIcon"><a target="_blank" href="https://play.google.com/store/apps/details?id=com.rasayaniallinone.myapplication&amp;pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1"><img alt="Get it on Google Play" src="'+myPath+'img/applogo.PNG" style="height:60px;border-radius:10px"></a></li>'+
							'</ul>'+
                        '</div>'+
                    '</div>'+
                '</div>'+
            ...
            '<div class="footer_bottom">'+
                '<p>Copyright@2020 <a href="javascript:void(0)" id="serviceArea">RasayaniAllinOne</a> All Rights Reserved</p>'+
            '</div>'+
        '</footer>';
	    		...
	    		'<div class="col-lg-12 d-block">'+
		    		'<div class="row d-flex">'+
						...
						'<div class="col-md-4">'+
							...
							'<span class="text playStoreIcon">&nbsp;<a href="https://play.google.com/store/apps/details?id=com.rasayaniallinone.myapplication&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1"><img alt="Get it on Google Play" src="img/applogo.PNG" style="height:40px;border-radius:10px;"/></a></span>'+
					    '</div>'+					   
				    '</div>'+
			    '</div>'+
		    '</div>'+
...
function openFBDetails(){
	window.open("https://www.facebook.com/sharer/sharer.php?u=rasayaniallinone.in", "pop", "width=600, height=400, scrollbars=no");
	return false;
}	